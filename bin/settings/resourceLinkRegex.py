RESOURCE_REGEX = {
        ...
        "cds" : r".*cds_from_genomic.fna.gz$",
        "featureCount" : r".*feature_count.txt.gz$",
        "featureTable" : r".*feature_table.txt.gz$",
        "genomicGaps" : r".*genomic_gaps.txt.gz$",
        "protein" : r".*_protein.faa.gz$"
        }
